package com.woomulwoomul.clientserver.controller.question

import com.woomulwoomul.clientserver.controller.RestDocsSupport
import com.woomulwoomul.clientserver.controller.question.request.AnswerCreateRequest
import com.woomulwoomul.clientserver.controller.question.request.AnswerUpdateRequest
import com.woomulwoomul.clientserver.service.question.AnswerService
import com.woomulwoomul.clientserver.service.question.response.*
...
class AnswerControllerTest : RestDocsSupport() {
    ...
    fun givenValid_whenUpdateAnswer_thenReturn200() {
        ...
        `when`(answerService.updateAnswer(anyLong(), anyLong(), any()))
            .thenReturn(
                com.woomulwoomul.clientserver.service.question.response.AnswerUpdateResponse(
                    1L,
                    "답변",
                    "https://t1.kakaocdn.net/account_images/default_profile.jpeg.twg.thumb.R640x640",
                    LocalDateTime.of(2024, 1, 1, 0, 0, 0),
                    ...
                    "0F0F0F",
                    listOf(
                        com.woomulwoomul.clientserver.service.question.response.AnswerUpdateCategoryResponse(
                            1L,
                            "카테고리1"
                        ),
                        com.woomulwoomul.clientserver.service.question.response.AnswerUpdateCategoryResponse(
