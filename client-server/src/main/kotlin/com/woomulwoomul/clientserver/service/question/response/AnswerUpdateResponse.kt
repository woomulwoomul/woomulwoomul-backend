package com.woomulwoomul.clientserver.service.question.response
...
data class AnswerUpdateResponse(
    ...
    val categories: List<com.woomulwoomul.clientserver.service.question.response.AnswerUpdateCategoryResponse>,
) {
    ...
    constructor(
        ...
        categories.map { com.woomulwoomul.clientserver.service.question.response.AnswerUpdateCategoryResponse(it) }
    )
}
