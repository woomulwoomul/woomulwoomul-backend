...
data class AnswerFindResponse(
    ...
    val categories: List<AnswerFindCategoryResponse>,
) {
    constructor(
        ...
        categories.map { AnswerFindCategoryResponse(it) }
    )
}

data class AnswerFindCategoryResponse(
    val categoryId: Long,
    val name: String,
) {
