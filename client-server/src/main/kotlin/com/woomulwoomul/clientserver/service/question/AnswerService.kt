...
import com.woomulwoomul.clientserver.service.question.request.AnswerCreateServiceRequest
import com.woomulwoomul.clientserver.service.question.request.AnswerUpdateServiceRequest
import com.woomulwoomul.clientserver.service.question.response.AnswerCreateResponse
import com.woomulwoomul.clientserver.service.question.response.AnswerFindAllResponse
import com.woomulwoomul.clientserver.service.question.response.AnswerFindResponse
import com.woomulwoomul.clientserver.service.question.response.AnswerUpdateResponse
import com.woomulwoomul.clientserver.service.s3.S3Service
...
class AnswerService(
     ...
     */
    @Transactional
    fun updateAnswer(userId: Long, answerId: Long, @Valid request: AnswerUpdateServiceRequest): com.woomulwoomul.clientserver.service.question.response.AnswerUpdateResponse {
        val questionAnswer = questionAnswerRepository.findAnswered(userId, answerId)
            ?: throw CustomException(ANSWER_NOT_FOUND)
        ...
        return com.woomulwoomul.clientserver.service.question.response.AnswerUpdateResponse(
            questionAnswer,
            answeredUserCnt,
            randomAnsweredImageUrls,
            questionCategories.map { it.category }
